    ...
    <main class="dashboard-content">
        <div class="container-fluid px-3 px-lg-4 py-4">
            <div class="page-heading d-flex justify-content-between align-items-center">
                <h1 class="h3 mb-1">{{ __("messages.add_product") }}</h1>
            ...
            <form class="panel needs-validation mt-3" method="POST" action="{{ route('products.store', ['locale' => app()->getLocale()]) }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="panel-body row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="brand_id" required>
                            <option value="">{{ __("messages.choose_brand") }}</option>
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control" id="price_after" name="price_after_discount" type="number" step="0.01"
                               value="{{ old('price_after_discount') }}" readonly>
                    </div>
                    ...
                    <div class="col-12 text-end">
                        <button type="submit" class="btn btn-success btn-sm">
                            <i class="bi bi-save"></i> {{ __("messages.create_product") }}
                        </button>
                    </div>
                </div>
            </form>
