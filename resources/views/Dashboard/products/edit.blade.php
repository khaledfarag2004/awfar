...
@section('content')
    <main class="dashboard-content">
        <div class="container-fluid px-3 px-lg-4 py-4">
            ...
            <form class="panel needs-validation mt-3" method="POST" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="panel-body row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="price" type="number" step="0.01" value="{{ old('price', $product->price) }}" required>
                    </div>
